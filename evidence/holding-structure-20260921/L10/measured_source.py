"""L10 native Binance development account diagnostic, never qualification."""
import argparse
...
def run(root,warmup,repairs,output):
    ...
    result=dict(candidate='L10',qualification='NOT_QUALIFIED',validation_used=False,cagr=cagr,mdd_conservative_envelope=str(mdd),
