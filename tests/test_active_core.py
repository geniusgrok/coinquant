...
class ActiveCoreTests(TestCase):
    def test_coherence_requires_all_three_completed_signs(self):
        opportunity=object()
    ...
    def test_restart_child_has_smaller_aggregate_mother_stop_budget(self):
        ...
        with self.assertRaises(ValueError):mother_stop_share('unknown',parent)


    def test_negative_daily_campaign_consumes_once_and_rearms_only_after_reset(self):
